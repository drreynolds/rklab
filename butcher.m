...
%           ESDIRK3(2)5L[2]SA  |  5 |  3   ?   Y       Y  |  2   ?           ?  |  ?  ?
%          ESDIRK3(2I)5L[2]SA  |  5 |  3   ?   ?       Y  |  2   ?           ?  |  ?  ?
...
%           ESDIRK4(3)6L[2]SA  |  6 |  4   ?   ?       Y  |  3   ?           ?  |  ?  ?
%          ESDIRK4(3I)6L[2]SA  |  6 |  4   ?   ?       Y  |  3   ?           ?  |  ?  ?
%          QESDIRK4(3)6L[2]SA  |  6 |  4   ?   ?       Y  |  3   ?           ?  |  ?  ?
%       ARK4(3)6L[2]SA-ESDIRK  |  6 |  4   4   Y       Y  |  3   3   Y          |  2  1e-40
%       ARK4(3)7L[2]SA-ESDIRK  |  7 |  4   4   Y       Y  |  3   3   Y       Y  |  2  1e-25
%           ESDIRK5(3)6L[2]SA  |  6 |  5   ?   ?       Y  |  3   ?           ?  |  ?  ?
%           ESDIRK5(4)7L[2]SA  |  7 |  5   ?   ?       Y  |  4   ?           ?  |  ?  ?
...
%          ESDIRK5(4I)8L[2]SA  |  8 |  5   ?   ?       Y  |  4   ?           ?  |  ?  ?
%             ESDIRK6(4)7A[2]  |  7 |  6   ?   ?          |  4   ?           ?  |  ?  ?
%
%
...
elseif (strcmp(method_name,'ESDIRK6(4)7A[2]'))
   ...
   A = [z, z, z, z, z, z, z; ...
        ...
        -v(3742173976023)/v(7880396319491), -v(4537732256035)/v(9784784042546), v(32234033847818)/v(24636233068093), v(1995418204833)/v(9606020544314),  v(5)/v(16), z, z; ...
         ...
         v(2429030329867)/v(4957732179206), -v(5124723475981)/v(12913403568538), v(3612624980699)/v(11761071195830), v(714493169479)/v(5549220584147), -v(4586610949246)/v(13858427945825), -v(4626134504839)/v(7500671962341), v(5)/v(16)];
   q = 6;
   p = 4;
   B = [c, A; q, b; p, b2];
...
elseif (strcmp(method_name,'ESDIRK5(4I)8L[2]SA'))
   ...
   A = [z, z, z, z, z, z, z, z; ...
        ...
        v(1783640092711)/v(14417713428467), -v(5781183663275)/v(18946039887294), v(57847255876685)/v(10564937217081), v(29339178902168)/v(9787613280015), v(122011506936853)/v(12523522131766), -v(60418758964762)/v(9539790648093), v(1)/v(4), z; ...
         b];
   q = 5;
   p = 4;
   B = [c, A; q, b; p, b2];
...
elseif (strcmp(method_name,'ESDIRK3(2)5L[2]SA'))
   ...
   c = [z; v(9)/v(20); v(9)*(v(2)+sqrt(v(2)))/v(80); v(3)/v(5); v(1)];
...
elseif (strcmp(method_name,'ESDIRK3(2I)5L[2]SA'))
   ...
   A = [z, z, z, z, z; ...
        v(9)/v(40), v(9)/v(40), z, z, z; ...
        v(19)/v(72), v(14)/v(15), v(9)/v(40), z, z; ...
