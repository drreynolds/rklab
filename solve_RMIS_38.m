function [tvals,Y,ns,nf] = solve_RMIS_38(fs,ff,tvals,Y0,hs,hf)
% usage: [tvals,Y,ns,nf] = solve_RMIS_38(fs,ff,tvals,Y0,hs,hf)
%
% Fixed time step RMIS-3/8, explicit+explicit multirate Runge-Kutta
...
% the "3/8-Rule" table, and calls step_RMIS.m in a loop to fill the
% output arrays.
%
% Inputs:
